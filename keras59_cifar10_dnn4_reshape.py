...
dense1 = Dense(30, activation= 'relu', input_shape = (32,32,3))(input1)
flt = Flatten()(dense1)
dense1 = Dense(30)(flt) #activation='relu', input_shape = (16*48*4,1)
dense1 = Dense(30, activation= 'relu')(dense1)
dense1 = Dense(10, activation= 'relu')(dense1)
dense1 = Dense(3072, activation= 'relu')(dense1)
dense1 = Reshape((32,32,3))(dense1)
...
model.fit(x_train, y_train, epochs = 1, batch_size = 64, validation_data= (x_val, y_val), verbose = 1 ,callbacks = [early_stopping])
