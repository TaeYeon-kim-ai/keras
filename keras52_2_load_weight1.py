...
model2 = Sequential()
model2.add(Conv2D(filters = 32, kernel_size=(2,2), strides =1 ,padding = 'SAME', input_shape = (28, 28, 1))) 
...
model2.summary()
model2.save('../data/h5/k52_1_model1.h5')#모델저장
...
#4. 평가, 예측
loss1 = model1.evaluate(x_test, y_test, batch_size=8)
print('loss : ', loss1)
y_pred1 = model1.predict(x_test[:10])
print(y_pred1)
print(y_test[:10])
print(np.argmax(y_test[:10], axis=-1))
# loss :  [0.317549467086792, 0.886900007724762]


#weight save -- load
model2 = model2.load_weights('../data/h5/k52_1_model2.h5')
loss2 = model1.evaluate(x_test, y_test, batch_size=8)
print('loss : ', loss2)
y_pred2 = model1.predict(x_test[:10])
print(y_pred2)
print(y_test[:10])
print(np.argmax(y_test[:10], axis=-1))
# loss :  [0.317549467086792, 0.886900007724762]
