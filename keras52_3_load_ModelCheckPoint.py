...
# 기존
# loss :  [0.317549467086792, 0.886900007724762] #튜닝 다시 몇번지나가서 earlystopping 했을 때의 값
# [9 2 1 1 6 1 4 6 5 7]

model = load_model('../data/modelCheckpoint/k52_1_mnist_checkpoint.hdf5')
result2 = model.evaluate(x_test, y_test, batch_size=8)
print('load_checkpoint_loss : ', result2[0])
print('load_checkpoint_acc : ', result2[1])
#result2 = model.predict(x_test[:10])
#print(np.argmax(y_test[:10], axis=-1))
# weight_loss :  0.3195295035839081
# weight_acc :  0.8870000243186951
# 가낭 낮았을 때 저장 된 값